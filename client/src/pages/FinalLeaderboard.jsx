// client/src/pages/FinalLeaderboard.jsx
    ...
    <div className="min-h-screen bg-[var(--bg-primary)] py-8 px-4">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-4xl font-bold mb-2 text-[var(--txt)]">Final Leaderboard</h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2">
            <div className="bg-[var(--bg-ter)] rounded-xl shadow-lg p-6">
              <h2 className="text-2xl font-bold mb-6 text-[var(--txt)]">All Participants</h2>
